...
# TODO: Replace <FILL IN> with appropriate code
wordCountsGrouped = wordsGrouped.map(lambda (key, val_Iter) : (key, sum(val_Iter)))
...
# TODO: Replace <FILL IN> with appropriate code
uniqueWords = wordCounts.keys().collect()
print uniqueWords
...
def wordCount(wordListRDD):
    ...
    """
    return(wordListRDD.map(lambda word : (word,1)).reduceByKey(lambda val1, val2 : val1 + val2))
